            ...
            <div class="row g-5">
                ...
                <div class="col-6 col-lg-2">
                    ...
                    <ul class="footer-links list-unstyled">
                        <li><a href="<?= ROOT;?>"><i class="bi bi-chevron-right"></i> Home</a></li>
                        <li><a href="<?= ROOT;?>"><i class="bi bi-chevron-right"></i> Blog</a></li>
                    ...
                    <ul class="footer-links footer-blog-entry list-unstyled">
                        <li>
                            <a href="single-post" class="d-flex align-items-center">
                                <img src="<?= ROOT; ?>/assets/frontend/img/post-sq-1.jpg" alt="" class="img-fluid me-3">
                                <div>
                        ...
                        <li>
                            <a href="single-post" class="d-flex align-items-center">
                                <img src="<?= ROOT; ?>/assets/frontend/img/post-sq-2.jpg" alt="" class="img-fluid me-3">
                                <div>
                                    <div class="post-meta d-block"><span class="date">Culture</span> <span class="mx-1">&bullet;</span> <span>Jul 5th '22</span></div>
                        ...
                        <li>
                            <a href="single-post" class="d-flex align-items-center">
                                <img src="<?= ROOT; ?>/assets/frontend/img/post-sq-3.jpg" alt="" class="img-fluid me-3">
                                <div>
                                    <div class="post-meta d-block"><span class="date">Culture</span> <span class="mx-1">&bullet;</span> <span>Jul 5th '22</span></div>
                        ...
                        <li>
                            <a href="single-post" class="d-flex align-items-center">
                                <img src="<?= ROOT; ?>/assets/frontend/img/post-sq-4.jpg" alt="" class="img-fluid me-3">
                                <div>
                                    <div class="post-meta d-block"><span class="date">Culture</span> <span class="mx-1">&bullet;</span> <span>Jul 5th '22</span></div>
...
<!-- Vendor JS Files -->
<script src="<?= ROOT; ?>/assets/frontend/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
<script src="<?= ROOT; ?>/assets/frontend/vendor/swiper/swiper-bundle.min.js"></script>
<script src="<?= ROOT; ?>/assets/frontend/vendor/glightbox/js/glightbox.min.js"></script>
<script src="<?= ROOT; ?>/assets/frontend/vendor/aos/aos.js"></script>
<script src="<?= ROOT; ?>/assets/frontend/vendor/php-email-form/validate.js"></script>

<!-- Template Main JS File -->
<script src="<?= ROOT; ?>/assets/frontend/js/main.js"></script>
